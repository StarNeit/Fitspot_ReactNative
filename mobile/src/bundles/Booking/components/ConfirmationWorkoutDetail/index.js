...
class ConfirmationWorkoutDetail extends React.Component {
  constructor(props) {
    super(props);
  ...
  render(){
    return(
      <View style ={styles.clientContainer}>
        ...
        <View style={{backgroundColor:'white', borderBottomColor:'black'}}>
          <Text style={{marginTop:6,marginBottom:6,fontFamily:FONT_DAYTONA_REG,fontWeight:'400',fontSize:15,textAlign:'center',alignItems:'center'}}>6 Co-Workers Confirmed</Text>
...
export default ConfirmationWorkoutDetail