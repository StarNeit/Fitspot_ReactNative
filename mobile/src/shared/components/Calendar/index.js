...
import styles, { WEEK_ROW_HEIGHT } from './styles';
      ...
      <View style={[styles.calendarContainer, this.props.customStyle.calendarContainer]}>
        ...
        {this.props.scrollEnabled ?
          <ScrollView
              ...
              style={{
               height: this.props.customStyle.dayButton && this.props.customStyle.dayButton.height ?
                      this.props.customStyle.dayButton.height * numOfWeeks :
                       WEEK_ROW_HEIGHT * numOfWeeks }}
              >
